...
using _Scripts.ApplicationLifecycle.Messages;
...
using ConnectStatus = _Scripts.Gameplay.ConnectionManagement.ConnectStatus;

namespace _Scripts.ApplicationLifeCycle
{
    /// <summary>
    ...
    public class ApplicationController : MonoBehaviour
    {
        ...
        private void Start()
        {
            SceneManager.LoadScene(ScenesEnum.MAIN_MENU);
        }
        ...
        private void LeaveSession(QuitGameSessionMessage msg)
        {
            ...
            SceneLoaderWrapper.Instance.LoadScene(ScenesEnum.MAIN_MENU, useNetworkSceneManager: false);
        }
