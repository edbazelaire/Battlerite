...
namespace _Scripts.Gameplay.Actions
{
    ...
    public abstract class Action : ActionBase
    {
        ...
        /// <summary>
        /// Begin the action after casting
        /// </summary>
        ...
        /// <summary>
        /// get final allowed range between a requested position and the character position
        /// </summary>
        /// <param name="requestedPosition"> position requested by the client </param>
        /// <returns></returns>
        protected float GetFinalRange(Vector3 requestedPosition)
        {
            ...
            var characterPosition = m_Parent.physicsWrapper.Transform.position;
            characterPosition.y = 0;
            requestedPosition.y = 0;
            
            var distance = Vector3.Distance(characterPosition, requestedPosition);
        ...
        /// <param name="requestedPosition"> position requested by the client </param>
        /// <returns></returns>
        protected Vector3 GetFinalPosition(Vector3 requestedPosition)
        {
            var finalDistance = GetFinalRange(requestedPosition);
            ...
            return characterPosition + (requestedPosition - characterPosition) * finalDistance / distance;
        }
        ...
        public static Action MakeAction(ServerCharacter parent, ref ActionRequestData data)
        {
            ...
            {
                throw new System.Exception($"Trying to create Action {data.ActionName} but it isn't defined on the GameDataSource!");
            }
            ...
            switch (logic)
            {
                ...
                case ActionLogic.Dash: return new DashAction(parent, ref data);
                case ActionLogic.Jump: return new JumpAction(parent, ref data);
                case ActionLogic.Toss: return new TossAction(parent, ref data);
                ...
                case ActionLogic.Shield: return new ShieldAction(parent, ref data);
                case ActionLogic.Counter: return new CounterAction(parent, ref data);
