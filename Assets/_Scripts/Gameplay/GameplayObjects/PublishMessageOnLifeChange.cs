    ...
    public class PublishMessageOnLifeChange : NetworkBehaviour
    {
        ...
        public override void OnNetworkSpawn()
        {
            if (IsServer)
            {
                ...
                var gameState = FindObjectOfType<ServerArenaState>();
                if (gameState != null)
                {
        ...
        void OnLifeStateChanged(LifeState previousState, LifeState newState)
        {
            ...
            {
                // PlayerName = m_NameState != null ? m_NameState.Name.Value : (FixedPlayerName)m_CharacterName,
                // CharacterName = m_CharacterClass.CharacterClass.CharacterName,
